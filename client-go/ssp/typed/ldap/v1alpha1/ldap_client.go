...
import (
	...
	"github.com/nevidanniu/sample-apispec/client-go/ssp/scheme"
...
// LdapV1alpha1Client is used to interact with features provided by the ldap.ssp.group group.
type LdapV1alpha1Client struct {
	restClient rest.Interface
}

func (c *LdapV1alpha1Client) Users() UserInterface {
	return newUsers(c)
}
...
// NewForConfigAndClient creates a new LdapV1alpha1Client for the given config and http client.
// Note the http client provided takes precedence over the configured transport values.
func NewForConfigAndClient(c *rest.Config, h *http.Client) (*LdapV1alpha1Client, error) {
	config := *c
	if err := setConfigDefaults(&config); err != nil {
		return nil, err
	}
