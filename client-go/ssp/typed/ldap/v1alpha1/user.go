...
type UserInterface interface {
	...
	Apply(ctx context.Context, user *ldapv1alpha1.UserApplyConfiguration, opts v1.ApplyOptions) (result *v1alpha1.User, err error)
	UserExpansion
}
...
func newUsers(c *LdapV1alpha1Client) *users {
	return &users{
		client: c.RESTClient(),
	}
}
...
func (c *users) Apply(ctx context.Context, user *ldapv1alpha1.UserApplyConfiguration, opts v1.ApplyOptions) (result *v1alpha1.User, err error) {
	if user == nil {
