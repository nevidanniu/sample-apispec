...
var tenantsResource = schema.GroupVersionResource{Group: "core.ssp.group", Version: "v1alpha1", Resource: "tenants"}

var tenantsKind = schema.GroupVersionKind{Group: "core.ssp.group", Version: "v1alpha1", Kind: "Tenant"}
...
func (c *FakeTenants) Apply(ctx context.Context, tenant *corev1alpha1.TenantApplyConfiguration, opts v1.ApplyOptions) (result *v1alpha1.Tenant, err error) {
	if tenant == nil {
	...
	obj, err := c.Fake.
		Invokes(testing.NewRootPatchSubresourceAction(tenantsResource, *name, types.ApplyPatchType, data), &v1alpha1.Tenant{})
	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.Tenant), err
